        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <h4 class="card-title">Finish Job Details : <?php echo $job_details['vehicle_plate'];?></h4>
                <p><?php echo $job_details['start_time'];?></p>
                
                <form class="forms-sample" method="POST" action="viewWorkshopJobs.php" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="jobcomment">Service Fee</label>
                    <input type="text" class="form-control" id="service_fee" name="service_fee" required placeholder="100,00">
                  </div>  
