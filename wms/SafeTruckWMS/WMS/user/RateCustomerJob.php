      ...
      <div class="main-panel">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <?php
                  if(isset($_POST['job_id']) && isset($_POST['feedback']) && isset($_POST['rating'])){
                ...
                <form class="forms-sample" method="POST" action="RateCustomerJob.php" enctype="multipart/form-data">
