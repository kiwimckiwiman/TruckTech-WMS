            ...
            <div class="col-sm-12">
              ...
              <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                    <?php
                    foreach($workshop_details as $row) {
                      echo " Workshop Name : " . $row['name'];
                  }
                  ?>
                   </li>
                  </ul>
                            ...
                            <div class="card-body">
                              <div class="d-sm-flex justify-content-between align-items-start">
                                <div>
                                 ...
                                 <p class="card-subtitle card-subtitle-dash">You have <?php echo(count($items))?> Inventory Items</p>
                                </div>
                                <!-- <div>
                              ...
                              <script>
                                ...
                                <?php
                                  ...
                                  if($count == 0){ ?>
                                    <tr>
                                  <td colspan="5" class="text-center"><h6>Zero inventory items</h6></td>
                                </tr>
                                  <?php } else {
