            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="table-responsive">
                  ...
                  <a href="view_inventory.php?pages=<?php if($pages == 1){echo $pages;}else{echo $pages-1;} ?>" class="btn btn-primary me-2">PREVIOUS</a>
                  <a href="view_inventory.php?pages=<?php if($count == 10){echo $pages+1;}else{echo $pages;} ?>" class="btn btn-primary me-2">NEXT</a>
