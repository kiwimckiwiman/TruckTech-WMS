    ...
    <div class="template-demo">
        <div class="form-group">
            ...
            foreach ($workshopOwners as $owner) {
                echo '<option id="itemChoose" value="'.$owner['item_id'].'">'.$owner['name'].' </option>';
            }
            ?>
            </select>
        </div>
        ...
        <button type="submit" class="btn btn-primary me-2" onclick="EditQuantity(<?php echo $_SESSION['workshop_id'] ?>)"  >Submit</button>
        ...
        <script>
          function EditQuantity(workshop_id){
            var quantity = document.getElementById('quantity').value;
            var item_id = document.getElementById('itemChoose').value;
           
            $.ajax({
              url: "EditQuantity.php",
              type: "POST",
              data:{quantity:quantity,item_id :item_id,workshop_id:workshop_id},
