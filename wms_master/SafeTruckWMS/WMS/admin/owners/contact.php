...
<?php
  ...
  if(isset($_POST["email"])){
    $msg = EmailAccount($_POST["email"], $_POST["header"], $_POST["content"]);
  }
?>
<head>
  <!-- Required meta tags -->
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample" method="POST" action="contact.php?id=<?php echo $owner["user_id"] ?>" name="email_send">
                        <div class="form-group">
                          <label for="email">Email</label>
                          <input type="email" class="form-control" name="email" placeholder="Email" required value="<?php echo $owner["email"]; ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <a href="view_owner.php?id=<?php echo $owner["user_id"]; ?>" class="btn btn-primary me-2">BACK</a>
