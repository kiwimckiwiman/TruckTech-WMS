                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="POST" action="delete_owner.php">
                      <a href="contact.php?id=<?php echo $owner["user_id"]; ?>" class="btn btn-primary me-2">CONTACT OWNER</a>
                      <input type="hidden" name="id" value="<?php echo $owner["user_id"]; ?>">
                          ...
                          echo '<div class="col-md-6 grid-margin stretch-card">
                                  <div class="card">
                                    <div class="card-body">
                                      ...
                                      <a href="../workshops/view_workshop.php?id='. $workshop['workshop_id'] .'"<button class="btn btn-primary" type="submit" >View</button></a>
                                    </div>
                                  </div>
                                </div>';
                        }
