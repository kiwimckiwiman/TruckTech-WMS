              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="table-responsive">
                    ...
                    <a href="view_owners.php?pages=<?php if($pages == 1){echo $page;}else{echo $pages-1;} ?>" class="btn btn-primary me-2">PREVIOUS</a>
                    <a href="view_owners.php?pages=<?php if($count < 10){echo $pages;}else{echo $pages+1;} ?>" class="btn btn-primary me-2">NEXT</a>
                  </div>
                  </div>
                </div>
              </div>
