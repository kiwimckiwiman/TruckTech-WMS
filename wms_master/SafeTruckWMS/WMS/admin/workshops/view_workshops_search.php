...
<?php
  ...
  if(isset($_POST["query"]) && !(empty($_POST["query"]))){
    ...
    $results = GetWorkshopSearch($query, $type);
  }else{
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method=POST action="view_workshops_search.php" class="search-form">
                  ...
                  <div class="table-responsive">
                    ...
                    <a href="view_workshops.php?pages=1" class="btn btn-primary me-2">RETURN TO ALL</a>
                  </div>
                  </div>
                </div>
              </div>
